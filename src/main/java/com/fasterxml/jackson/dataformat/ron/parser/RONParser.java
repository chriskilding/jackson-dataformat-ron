...
// case ']':  // 11-May-2020, tatu: related to [core#616], this should never be reached
    ...
    private JsonToken _parseFloat(int ch, int startPtr, int ptr, boolean neg, int intLen)
        throws IOException
    {
        final int inputLen = _inputEnd;
        int fractLen = 0;
    ...
    protected JsonToken _handleOddValue(int i) throws IOException
    {
        ...
        case 'i':
            _matchToken("inf", 1);
            // FIXME support negative infinity (-inf)
            return resetAsNaN("inf", Double.POSITIVE_INFINITY);
    ...
    private int _skipColonFast(int ptr) throws IOException
    {
